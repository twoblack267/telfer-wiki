...
// [[Lawrie Family - Carslake Connection]] in a History/ folder, which the author
// linked on purpose and which the renderer's formatBody leaves as its alias text.
// lookupSlug() only knows people, so such a link returns null and this guard
// reported it as a DEAD person-link and BLOCKED the build. The vault was correct;
// the guard had no way to know the note exists (tw-2026-09-18-006).
//
